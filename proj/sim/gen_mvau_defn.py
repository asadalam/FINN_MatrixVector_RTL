...
#
# None
def gen_mvau_defn(kdim,iwl,iwb,ifmc,ofmc,ifmd,wwl,wwb,op_sgn,owl,simd,pe,mmv,stride=1):
    ...
    mvau_defn.write(" * OP_SGN                                       - Enumerated values showing signedness/unsignedness of input activation/weights\n")
    mvau_defn.write(" * DSP_TRUE                                      - Use DSP blocks or LUTs for MAC (future extension)\n")
