/*
 * Module: mvau_tb_v5.sv (testbench)
 * 
 ...
 * DUT is matched against data generated from HLS where the rready signal is given
 * different delays before responding to the output valid.
 * 
 * This test bench is part of the regression test for MVAU batch unit.
 * 
...
module mvau_tb_v5;
   ...
   always @(out_v) begin
      //rready = 1'b0;
      assign rand_dly = $urandom_range(50,150);   
      #(CLK_PER*rand_dly+1)
      rready = out_v;
   end
