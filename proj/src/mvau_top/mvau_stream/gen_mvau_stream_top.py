...
def gen_mvau_stream_top(kdim,iwl,iwb,ifmc,ofmc,ifmd,wwl,wwb,owl,simd,pe,stride=1,mmv=1):
    ...
    mvau_stream_top.write(" * OP_SGN                                       - Enumerated values showing signedness/unsignedness of input activation/weights\n")
    mvau_stream_top.write(" * DSP_TRUE                                      - Use DSP blocks or LUTs for MAC (future extension)\n")
    ...
    mvau_stream_top.write("   parameter integer OP_SGN=%d, // Enumerated values showing signedness/unsignedness of input activation/weights\n" % op_sgn)
    mvau_stream_top.write("   parameter integer DSP_TRUE=0, // Use DSP blocks or LUTs for MAC\n")
    ...
    mvau_stream_top.write("   .OP_SGN      (OP_SGN    ), \n")
    mvau_stream_top.write("   .DSP_TRUE     (DSP_TRUE   ), \n")
