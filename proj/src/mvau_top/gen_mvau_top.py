...
def gen_mvau_top(kdim,iwl,iwb,ifmc,ofmc,ifmd,wwl,wwb,owl,simd,pe,stride=1,mmv=1):
    mvau_top = open("mvau.v","wt")
    stride=1
    pad=0
    mmv=1    
    mvau_top.write("/*\n")
    mvau_top.write(" * Module: MVAU Top Level (mvau)\n")
    mvau_top.write(" * \n")
    ...
    mvau_top.write(" \n")
    mvau_top.write(" 		 // Axis Stream integererface\n")
    mvau_top.write(" 		 input  	       rready,\n")
    mvau_top.write(" 		 output  	       wready,\n")
    mvau_top.write(" 		 \n")
    mvau_top.write(" 		 input  [TI-1:0]  in, // input stream\n")
    mvau_top.write(" 		 input  	       in_v, // input valid\n")
    mvau_top.write(" 		 output  	       out_v, // Output valid\n")
    mvau_top.write(" 		 output  [TO-1:0] out); //output stream\n")
    mvau_top.write(" \n")
    mvau_top.write("   mvau #(\n")
    ...
    mvau_top.write(" 		  .rready(rready),\n")
    mvau_top.write(" 		  .wready(wready),\n")
    mvau_top.write(" 		  .in(in),\n")
    mvau_top.write(" 		  .in_v(in_v),\n")
    mvau_top.write(" 		  .out_v(out_v),\n")
    mvau_top.write(" 		  .out(out)\n")
    mvau_top.write(" 		  );\n")
    mvau_top.write("      \n")
