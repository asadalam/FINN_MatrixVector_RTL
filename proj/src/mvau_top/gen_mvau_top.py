...
def gen_mvau_top(kdim,iwl,iwb,ifmc,ofmc,ifmd,wwl,wwb,owl,simd,pe,stride=1,mmv=1):
    ...
    mvau_top.write(" * rready - Input ready which tells that the successor logic is ready to receive data\n")
    mvau_top.write(" * [TI-1:0] in - Input stream, word length TI=TSrcI*SIMD\n")
    mvau_top.write(" * in_v - Input valid, indicates valid input\n")
    mvau_top.write(" * \n")
    mvau_top.write(" * Outputs:\n")
    mvau_top.write(" * wready - Output ready which tells the predecessor logic to start providing data\n")
    mvau_top.write(" * out_v        - Output stream valid\n")
    mvau_top.write(" * [TO-1:0] out - Output stream, word length TO=TDstI*PE \n")
    mvau_top.write(" * \n")
    mvau_top.write(" * Parameters:\n")
    mvau_top.write(" * WMEM_ADDR_BW - Word length of the address for the weight memories (log2(WMEM_DEPTH))\n")
    mvau_top.write(" * */\n")
    mvau_top.write(" \n")
    ...
    mvau_top.write(" 		 input  	       s0_axis_tready,\n")
    mvau_top.write(" 		 output  	       m0_axis_tready,\n")
    mvau_top.write(" 		 \n")
    mvau_top.write(" 		 input  [TI-1:0]  m0_axis_tdata, // input stream\n")
    mvau_top.write(" 		 input  	       m0_axis_tvalid, // input valid\n")
    mvau_top.write(" 		 output  	       s0_axis_tvalid, // Output valid\n")
    mvau_top.write(" 		 output  [TO-1:0] s0_axis_tdata); //output stream\n")
    mvau_top.write(" \n")
    mvau_top.write("   mvau #(\n")
    ...
    mvau_top.write(" 		  .rready(s0_axis_tready),\n")
    mvau_top.write(" 		  .wready(m0_axis_tready),\n")
    mvau_top.write(" 		  .in(m0_axis_tdata),\n")
    mvau_top.write(" 		  .in_v(m0_axis_tvalid),\n")
    mvau_top.write(" 		  .out_v(s0_axis_tvalid),\n")
    mvau_top.write(" 		  .out(s0_axis_tdata)\n")
    mvau_top.write(" 		  );\n")
    mvau_top.write("      \n")
