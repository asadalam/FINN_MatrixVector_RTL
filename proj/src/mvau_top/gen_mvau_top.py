...
def gen_mvau_top(kdim,iwl,iwb,ifmc,ofmc,ifmd,wwl,wwb,owl,simd,pe,mmv,stride=1):
    ...
    mvau_top.write(" * USE_DSP                                      - Use DSP blocks or LUTs for MAC (future extension)\n")
    ...
    mvau_top.write("   parameter integer USE_DSP=0, // Use DSP blocks or LUTs for MAC\n")
    ...
    mvau_top.write("   .USE_DSP    (USE_DSP   ), \n")
